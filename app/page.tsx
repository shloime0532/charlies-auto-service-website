  ...
  return (
    <>
      ...
      <section className="bg-primary pt-16 md:pt-20">
        <div className="mx-auto grid max-w-7xl items-center gap-8 px-4 py-12 sm:px-6 md:grid-cols-2 md:gap-12 md:py-20 lg:px-8 lg:py-28">
          {/* Left — Copy */}
          <div className="flex flex-col items-center text-center md:items-start md:text-left">
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <a
                href="tel:8482221964"
                className="group flex items-center justify-center gap-3 rounded-xl bg-accent px-8 py-4 text-lg font-bold text-white shadow-lg shadow-accent/25 transition-all hover:bg-accent-light hover:shadow-xl"
              >
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4 text-sm text-white/50 sm:gap-6 md:justify-start">
              ...
              <button
                ...
                className={`flex shrink-0 items-center gap-2 rounded-xl px-5 py-3 text-sm font-semibold transition-all md:px-6 md:py-3.5 md:text-base ${
                  activeTab === service.id
                    ...
                    : "bg-white text-text-light shadow-sm hover:text-primary hover:shadow-md"
                }`}
              >
          ...
          >
            <div className="grid gap-8 md:grid-cols-2">
              ...
              <div>
                ...
                <div className="rounded-xl border border-blue/10 bg-blue/5 p-4">
            ...
            {[
              {
                ...
                icon: <PhoneIcon className="h-8 w-8 text-accent" />,
              },
              {
                step: "02",
                title: "We Diagnose",
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {testimonials.map((t, i) => (
              ...
              >
                ...
                <p className="mt-4 mb-6 leading-relaxed text-text-light">
                  &ldquo;{t.text}&rdquo;
                </p>
      ...
      <section className="relative overflow-hidden bg-primary">
        <div className="mx-auto grid max-w-7xl items-center md:grid-cols-2">
          ...
          <div className="relative h-64 md:h-[400px]">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-b from-transparent to-primary/60 md:bg-gradient-to-r md:from-transparent md:to-primary/80" />
          </div>
          {/* Content */}
          ...
          <div className="space-y-3">
            {faqs.map((faq, i) => (
              ...
              >
                ...
                >
                  <p className="px-6 pb-5 leading-relaxed text-text-light">
                    {faq.answer}
                  </p>
                </div>
              </div>
      ...
      <section className="bg-primary py-16 md:py-24">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <a
              href="tel:8482221964"
              className="group flex items-center gap-3 rounded-xl bg-accent px-10 py-5 text-xl font-bold text-white shadow-lg shadow-accent/25 transition-all hover:bg-accent-light hover:shadow-xl"
            >
              <PhoneIcon className="h-7 w-7 transition-transform group-hover:scale-110" />
              (848) 222-1964
            </a>
